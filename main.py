...
def parse_args():
    ...
    parser.add_argument('--resume_train', type=str, default='/home/nripendra/BBAVectors-Oriented-Object-Detection/weights_dota/model_130.pth', help='Weights resumed in training')
    parser.add_argument('--resume', type=str, default='model_120.pth', help='Weights resumed in testing and evaluation')
    parser.add_argument('--dataset', type=str, default='dota', help='Name of dataset')
    parser.add_argument('--data_dir', type=str, default='/home/nripendra/BBAVectors-Oriented-Object-Detection/Datasets/train/', help='Data directory')
